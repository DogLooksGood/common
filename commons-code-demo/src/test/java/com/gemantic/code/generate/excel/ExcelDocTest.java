...
public class ExcelDocTest {
	...
	public void testParseExcelDoc() throws Exception {
		...
		//xlsx文件模板：commons-code-demo/src/resources/document/collocation/collocationnew.xlsx
		CProject cProject = excelDesignDocParser.parseDesignDoc("document/collocation/collocationnew.xlsx");
